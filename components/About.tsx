...
export default function About() {
  return (
    <section id="about" className="py-24 md:py-32 px-6 md:px-12 bg-[#F3F0E9] text-[#0A0A0A] border-b border-[#0A0A0A] relative paper-grain">
      ...
      {/* Full-Width Edge-to-Edge Cream Pillar Container */}
      <div className="w-full bg-[#F3F0E9] text-[#0A0A0A] py-16 md:py-20 border-t border-[#0A0A0A]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 pt-6">
            {pillars.map((pillar, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: idx * 0.1 }}
                className={`py-8 md:py-0 ${idx !== 0 ? 'md:pl-8 lg:pl-12' : ''} ${
                  idx !== 2 ? 'md:pr-8 lg:pr-12 md:border-r border-[#0A0A0A]/20' : ''
              ...
              >
                <div>
                  ...
                  <h4 className="text-2xl md:text-3xl font-display uppercase tracking-tight mb-4 text-[#0A0A0A]">
                    {pillar.title}
                  </h4>

                  <p className="text-xs md:text-sm text-[#0A0A0A]/75 font-light leading-relaxed mb-8">
                    {pillar.desc}
                  </p>
                </div>
                ...
                <div>
                  <div className="flex flex-wrap gap-1.5 pt-2">
                    {pillar.tags.map((tag, tIdx) => (
                      <span
                        key={tIdx}
                        className="text-[10px] font-mono uppercase tracking-wider px-2 py-1 bg-[#0A0A0A]/5 text-[#0A0A0A]"
                      >
                        {tag}
                      </span>
                    ))}
